...
set fofb_gtx [create_ip -name gtwizard -vendor xilinx.com -library ip -version 3.6 -module_name fofb_gtx]
...
set_property -dict [list \
  ...
  CONFIG.gt3_val {true} \
  CONFIG.gt3_val_rx_refclk {REFCLK0_Q0} \
  CONFIG.gt3_val_tx_refclk {REFCLK0_Q0} \
