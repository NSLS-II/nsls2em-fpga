...
create_clock -period 8.000 [get_ports gtx_fofb_refclk_p]
...
set_property PACKAGE_PIN U9 [get_ports gtx_fofb_refclk_p]
set_property PACKAGE_PIN V9 [get_ports gtx_fofb_refclk_n]
